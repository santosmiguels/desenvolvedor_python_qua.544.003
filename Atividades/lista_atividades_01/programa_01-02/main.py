...
print("Cinema Python")
sala01 = print("1 - A volta dos que não foram (livre)")
sala02 = print("2 - A roda quadrada (12 anos)")
sala03 = print("3 - As tranças do rei careca (14 anos)")
sala04 = print("4 - Poeira em alto mar (16 anos)")
sala05 = print("5 - A vingança do frango assado (18 anos)")
...
match opcao:
    case 1:
        print("Divirta-se!")
        with open(f"{nome}.txt", "w", encoding="utf-8") as s:
